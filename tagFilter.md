...
.option-inline:has(#test:checked) ~ .wrapper .testable, .option-inline:has(#planet:checked) ~ .wrapper .materials, .option-inline:has(#planet:checked) ~ .wrapper .energy, .option-inline:has(#planet:checked) ~ .wrapper .water, .option-inline:has(#planet:checked) ~ .wrapper .emissions, .option-inline:has(#standards:checked) ~ .wrapper .standards, .option-inline:has(#consideration:checked) ~ .wrapper .considerations, .option-inline:has(#categories:checked) ~ .wrapper .categories,
...
.summary ul, .mt, .ht, .mh, .mm, .ml, .eh, .em, .el, .wh, .wm, .wl, .ch, .cm, .cl, .afnor, .aws, .azure, .gpf, .gr491, .greenit, .opquast, .sdgs, .ca, .cp, .cs, .assets, .compatibility, .content, .css, .e-waste, .education, .governance, .hardware, .html, .ideation, .javascript, .kpis, .marketing, .networking, .patterns, .performance, .report, .research, .equity, .software, .strategy, .ui, .usability,
